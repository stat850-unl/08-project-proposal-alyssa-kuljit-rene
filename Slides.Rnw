...
\begin{frame}{Food Access vs. Grocery Store Availability by State}
 \begin{itemize}
  \item Fewer grocery stores by state result in lower rates of food access
 \end{itemize}
 \begin{figure}
   \includegraphics[width=0.8\textwidth]{LowAccessStores2015.jpg}
   \hfill
 \end{figure}
\end{frame}
...
\begin{frame}{Comparision of Food Insecurity to Grocery Store Availability}
 \begin{itemize}
  \item Fewer grocery stores by state result in lower rates of food insecurity
 \end{itemize}
 \begin{figure}
   \includegraphics[width=0.8\textwidth]{FoodInsecure2017.jpg}
   \hfill
 \end{figure}
\end{frame}
...
\begin{frame}{Comparing State Population to Grocery Stores}
 ...
 \end{itemize}
 \begin{figure}
   \includegraphics[width=0.8\textwidth]{StorePop2015.jpg}
   \hfill
 \end{figure}
\end{frame}
